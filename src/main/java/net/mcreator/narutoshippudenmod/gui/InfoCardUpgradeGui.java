...
import net.mcreator.narutoshippudenmod.procedures.TaijutsuButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.SummoningButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.Spuse5Procedure;
import net.mcreator.narutoshippudenmod.procedures.Spuse1Procedure;
import net.mcreator.narutoshippudenmod.procedures.Spuse10Procedure;
import net.mcreator.narutoshippudenmod.procedures.SpeedProcedure;
import net.mcreator.narutoshippudenmod.procedures.ShurikenjutsuButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.SenjutsuButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.NinjutsuButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.MedicalButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.KinjutsuButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.KenjutsuButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.JutsuPowerButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.InfoCardOpenOnKeyPressedProcedure;
import net.mcreator.narutoshippudenmod.procedures.IQButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.GenjutsuButtonProcedure;
...
public class InfoCardUpgradeGui extends NarutoShippudenModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("info_card_upgrade"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, InfoCardUpgradeGuiWindow::new));
	}
