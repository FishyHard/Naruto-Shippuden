...
import net.mcreator.narutoshippudenmod.procedures.VillageSelectMinusProcedure;
import net.mcreator.narutoshippudenmod.procedures.VIllageSelectPlusProcedure;
import net.mcreator.narutoshippudenmod.procedures.NatureReleasePlusProcedure;
import net.mcreator.narutoshippudenmod.procedures.NatureReleaseMinusProcedure;
import net.mcreator.narutoshippudenmod.procedures.ClanReleasePlusProcedure;
import net.mcreator.narutoshippudenmod.procedures.ClanReleaseMinusProcedure;
import net.mcreator.narutoshippudenmod.procedures.ButtonSelectPressProcedure;
...
public class StatSelectGui extends NarutoShippudenModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("stat_select"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, StatSelectGuiWindow::new));
	}
