...
import net.mcreator.narutoshippudenmod.procedures.SelectDojutsuInfoProcedure;
import net.mcreator.narutoshippudenmod.procedures.PupilsHeightButtonMinusProcedure;
import net.mcreator.narutoshippudenmod.procedures.InfoCardOpenOnKeyPressedProcedure;
import net.mcreator.narutoshippudenmod.procedures.EyesHeightButtonMinusProcedure;
import net.mcreator.narutoshippudenmod.procedures.DojutsuButtonPlusProcedure;
import net.mcreator.narutoshippudenmod.procedures.DojutsuButtonMinusProcedure;
import net.mcreator.narutoshippudenmod.procedures.ButtonDojutsuSelect2PlusProcedure;
import net.mcreator.narutoshippudenmod.procedures.ButtonDojutsuSelect2MinusProcedure;
...
public class InfoCardDojutsuGui extends NarutoShippudenModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("info_card_dojutsu"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, InfoCardDojutsuGuiWindow::new));
	}
