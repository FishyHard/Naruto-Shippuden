...
import net.mcreator.narutoshippudenmod.procedures.SelectMenuProcedure;
import net.mcreator.narutoshippudenmod.procedures.SPMINUS10Procedure;
import net.mcreator.narutoshippudenmod.procedures.SPMINUS100Procedure;
import net.mcreator.narutoshippudenmod.procedures.SPADD10Procedure;
import net.mcreator.narutoshippudenmod.procedures.SPADD100Procedure;
import net.mcreator.narutoshippudenmod.procedures.ResetUpgradeStatsProcedure;
import net.mcreator.narutoshippudenmod.procedures.ResetLevelJPandSPProcedure;
import net.mcreator.narutoshippudenmod.procedures.ResetInfoStatsProcedure;
import net.mcreator.narutoshippudenmod.procedures.RankSetKageProcedure;
import net.mcreator.narutoshippudenmod.procedures.RankSetJoninProcedure;
import net.mcreator.narutoshippudenmod.procedures.RankSetGeninProcedure;
import net.mcreator.narutoshippudenmod.procedures.RankSetChuninProcedure;
import net.mcreator.narutoshippudenmod.procedures.RankSetAcademyStudentProcedure;
import net.mcreator.narutoshippudenmod.procedures.LevelXPAdd100Procedure;
import net.mcreator.narutoshippudenmod.procedures.JPMINUS10Procedure;
import net.mcreator.narutoshippudenmod.procedures.JPMINUS100Procedure;
import net.mcreator.narutoshippudenmod.procedures.JPADD10Procedure;
import net.mcreator.narutoshippudenmod.procedures.JPADD100Procedure;
import net.mcreator.narutoshippudenmod.procedures.CheatKekkeiGenkaiButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.CheatDojutsuButtonProcedure;
import net.mcreator.narutoshippudenmod.procedures.ADDMAXCHAKRAProcedure;
...
public class NarutoShippudenCheatGUIGui extends NarutoShippudenModElements.ModElement {
