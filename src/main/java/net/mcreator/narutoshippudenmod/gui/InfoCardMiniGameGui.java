...
import net.mcreator.narutoshippudenmod.procedures.PressButtonMiniProcedure;
import net.mcreator.narutoshippudenmod.procedures.InfoCardOpenOnKeyPressedProcedure;
import net.mcreator.narutoshippudenmod.procedures.InfoCardMiniGameWhileThisGUIIsOpenTickProcedure;
import net.mcreator.narutoshippudenmod.procedures.InfoCardMiniGameThisGUIIsClosedProcedure;
...
public class InfoCardMiniGameGui extends NarutoShippudenModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("info_card_mini_game"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, InfoCardMiniGameGuiWindow::new));
	}
