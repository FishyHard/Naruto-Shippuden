...
import net.mcreator.narutoshippudenmod.procedures.InsectBogProjectileHitsLivingEntityProcedure;
import net.mcreator.narutoshippudenmod.procedures.GreatFireballWhileProjectileFlyingTickProcedure;
import net.mcreator.narutoshippudenmod.entity.renderer.InsectBogRenderer;
...
public class InsectBogItem extends NarutoShippudenModElements.ModElement {
