...
import net.mcreator.narutoshippudenmod.procedures.ChakraNatureResetRightclickedProcedure;
import net.mcreator.narutoshippudenmod.itemgroup.ReleasesItemGroup;
...
public class ChakraNatureResetItem extends NarutoShippudenModElements.ModElement {
