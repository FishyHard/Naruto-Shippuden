...
import net.mcreator.narutoshippudenmod.procedures.EarthDNARightClickedProcedure;
import net.mcreator.narutoshippudenmod.procedures.EarthDNAImplantMobProcedure;
...
public class EarthDNAItem extends NarutoShippudenModElements.ModElement {
