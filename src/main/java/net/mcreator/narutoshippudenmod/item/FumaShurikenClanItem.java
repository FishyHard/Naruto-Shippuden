...
import net.mcreator.narutoshippudenmod.entity.renderer.FumaShurikenClanRenderer;
import net.mcreator.narutoshippudenmod.NarutoShippudenModElements;

import java.util.Random;

@NarutoShippudenModElements.ModElement.Tag
public class FumaShurikenClanItem extends NarutoShippudenModElements.ModElement {
