...
import net.mcreator.narutoshippudenmod.procedures.MirrorProjectileHitsLivingEntityProcedure;
import net.mcreator.narutoshippudenmod.procedures.GreatFireballWhileProjectileFlyingTickProcedure;
import net.mcreator.narutoshippudenmod.entity.renderer.MirrorRenderer;
...
public class MirrorItem extends NarutoShippudenModElements.ModElement {
