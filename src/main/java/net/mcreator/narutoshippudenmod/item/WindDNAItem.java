...
import net.mcreator.narutoshippudenmod.procedures.WindDNARightClickedProcedure;
import net.mcreator.narutoshippudenmod.procedures.WindDNAImplantMobProcedure;
...
public class WindDNAItem extends NarutoShippudenModElements.ModElement {
