...
import net.mcreator.narutoshippudenmod.procedures.WoodDNARightClickedProcedure;
import net.mcreator.narutoshippudenmod.procedures.WoodDNAImplantMobProcedure;
...
public class WoodDNAReleaseItem extends NarutoShippudenModElements.ModElement {
