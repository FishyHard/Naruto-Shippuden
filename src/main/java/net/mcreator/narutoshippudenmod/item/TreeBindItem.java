...
import net.mcreator.narutoshippudenmod.procedures.TreeBindProjectileHitsLivingEntityProcedure;
import net.mcreator.narutoshippudenmod.procedures.GreatFireballWhileProjectileFlyingTickProcedure;
import net.mcreator.narutoshippudenmod.entity.renderer.TreeBindRenderer;
...
public class TreeBindItem extends NarutoShippudenModElements.ModElement {
