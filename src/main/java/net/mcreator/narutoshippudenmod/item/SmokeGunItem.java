...
import net.mcreator.narutoshippudenmod.procedures.SmokeGunWhileProjectileFlyingTickProcedure;
import net.mcreator.narutoshippudenmod.entity.renderer.SmokeGunRenderer;
...
public class SmokeGunItem extends NarutoShippudenModElements.ModElement {
