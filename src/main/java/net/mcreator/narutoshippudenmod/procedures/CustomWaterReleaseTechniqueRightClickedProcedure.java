...
import net.mcreator.narutoshippudenmod.item.WaterWaveItem;
import net.mcreator.narutoshippudenmod.item.WaterDiskItem;
import net.mcreator.narutoshippudenmod.item.WaterBallItem;
import net.mcreator.narutoshippudenmod.NarutoShippudenModVariables;
import net.mcreator.narutoshippudenmod.NarutoShippudenMod;

import java.util.Map;

public class CustomWaterReleaseTechniqueRightClickedProcedure {
