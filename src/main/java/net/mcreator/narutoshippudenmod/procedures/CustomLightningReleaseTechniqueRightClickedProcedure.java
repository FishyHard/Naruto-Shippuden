...
import net.mcreator.narutoshippudenmod.item.LightningWaveItem;
import net.mcreator.narutoshippudenmod.item.LightningDiskItem;
import net.mcreator.narutoshippudenmod.item.LightningBallCustomItem;
import net.mcreator.narutoshippudenmod.NarutoShippudenModVariables;
import net.mcreator.narutoshippudenmod.NarutoShippudenMod;

import java.util.Map;

public class CustomLightningReleaseTechniqueRightClickedProcedure {
