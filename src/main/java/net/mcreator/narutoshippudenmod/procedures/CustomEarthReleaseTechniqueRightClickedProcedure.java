...
import net.mcreator.narutoshippudenmod.item.EarthWaveItem;
import net.mcreator.narutoshippudenmod.item.EarthDiskItem;
import net.mcreator.narutoshippudenmod.item.EarthBallItem;
import net.mcreator.narutoshippudenmod.NarutoShippudenModVariables;
import net.mcreator.narutoshippudenmod.NarutoShippudenMod;

import java.util.Map;

public class CustomEarthReleaseTechniqueRightClickedProcedure {
