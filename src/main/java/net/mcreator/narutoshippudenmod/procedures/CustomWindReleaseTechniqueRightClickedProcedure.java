...
import net.mcreator.narutoshippudenmod.item.WindDiskItem;
import net.mcreator.narutoshippudenmod.item.WindBallItem;
import net.mcreator.narutoshippudenmod.NarutoShippudenModVariables;
import net.mcreator.narutoshippudenmod.NarutoShippudenMod;

import java.util.Map;

public class CustomWindReleaseTechniqueRightClickedProcedure {
