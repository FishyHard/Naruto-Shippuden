...
import net.mcreator.narutoshippudenmod.particle.TailedBeastBombParticleRedParticle;
import net.mcreator.narutoshippudenmod.particle.TailedBeastBombParticleBlueParticle;
import net.mcreator.narutoshippudenmod.NarutoShippudenMod;

import java.util.Map;

public class TailedBeastBombWhileProjectileFlyingTickProcedure {
