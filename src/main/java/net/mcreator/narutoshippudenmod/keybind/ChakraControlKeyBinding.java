...
import net.mcreator.narutoshippudenmod.procedures.ChakraControlOnKeyReleasedProcedure;
import net.mcreator.narutoshippudenmod.procedures.ChakraControlOnKeyPressedProcedure;
...
public class ChakraControlKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
