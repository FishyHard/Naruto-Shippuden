...
import net.mcreator.narutoshippudenmod.procedures.BackDashOnKeyPressedProcedure;
...
public class BackDashKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
