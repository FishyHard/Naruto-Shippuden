...
import net.mcreator.narutoshippudenmod.procedures.IsshikiDojutsuOnKeyPressedProcedure;
...
public class IsshikiDojutsuKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
