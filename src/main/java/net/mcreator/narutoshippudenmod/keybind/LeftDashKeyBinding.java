...
import net.mcreator.narutoshippudenmod.procedures.LeftDashOnKeyPressedProcedure;
...
public class LeftDashKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
