...
import net.mcreator.narutoshippudenmod.procedures.ForwardDashOnKeyReleasedProcedure;
import net.mcreator.narutoshippudenmod.procedures.ForwardDashOnKeyPressedProcedure;
...
public class ForwardDashKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
