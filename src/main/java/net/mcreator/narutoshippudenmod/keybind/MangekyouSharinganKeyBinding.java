...
import net.mcreator.narutoshippudenmod.procedures.MangekyouSharinganOnKeyPressedProcedure;
...
public class MangekyouSharinganKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
