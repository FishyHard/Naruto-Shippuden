...
import net.mcreator.narutoshippudenmod.procedures.SharinganOnKeyPressedProcedure;
...
public class SharinganKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
