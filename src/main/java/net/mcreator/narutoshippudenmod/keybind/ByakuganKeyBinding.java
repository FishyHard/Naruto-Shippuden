...
import net.mcreator.narutoshippudenmod.procedures.ByakuganOnKeyPressedProcedure;
...
public class ByakuganKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
