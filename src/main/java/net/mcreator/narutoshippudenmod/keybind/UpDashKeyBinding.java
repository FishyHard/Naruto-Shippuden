...
import net.mcreator.narutoshippudenmod.procedures.UpDashOnKeyReleasedProcedure;
import net.mcreator.narutoshippudenmod.procedures.UpDashOnKeyPressedProcedure;
...
public class UpDashKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
