...
import net.mcreator.narutoshippudenmod.procedures.RinneganOnKeyPressedProcedure;
...
public class RinneganKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
