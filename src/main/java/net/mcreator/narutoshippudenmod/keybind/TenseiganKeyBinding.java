...
import net.mcreator.narutoshippudenmod.procedures.TenseiganOnKeyPressedProcedure;
...
public class TenseiganKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
