...
import net.mcreator.narutoshippudenmod.procedures.JutsuPowerOnKeyPressedProcedure;
...
public class JutsuPowerKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
