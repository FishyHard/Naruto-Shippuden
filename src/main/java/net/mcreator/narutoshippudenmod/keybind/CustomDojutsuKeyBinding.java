...
import net.mcreator.narutoshippudenmod.procedures.CustomDojutsuOnKeyPressedProcedure;
...
public class CustomDojutsuKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
