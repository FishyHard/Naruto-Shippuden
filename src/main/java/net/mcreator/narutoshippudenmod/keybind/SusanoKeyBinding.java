...
import net.mcreator.narutoshippudenmod.procedures.SusanoOnKeyPressedProcedure;
...
public class SusanoKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
