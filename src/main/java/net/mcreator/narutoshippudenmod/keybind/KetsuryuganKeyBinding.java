...
import net.mcreator.narutoshippudenmod.procedures.KetsuryuganOnKeyPressedProcedure;
...
public class KetsuryuganKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
