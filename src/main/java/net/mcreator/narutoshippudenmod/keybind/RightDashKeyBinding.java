...
import net.mcreator.narutoshippudenmod.procedures.RightDashOnKeyPressedProcedure;
...
public class RightDashKeyBinding extends NarutoShippudenModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
