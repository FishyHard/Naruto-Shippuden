...
import net.mcreator.narutoshippudenmod.procedures.IceMirrorEffectOnEffectActiveTickProcedure;
import net.mcreator.narutoshippudenmod.procedures.IceMirrorEffectEffectExpiresProcedure;
...
public class IceMirrorEffectPotionEffect {
