...
import net.mcreator.narutoshippudenmod.procedures.DrowningOnEffectActiveTickProcedure;
import net.mcreator.narutoshippudenmod.procedures.DrowningEffectExpiresProcedure;
...
public class DrowningPotionEffect {
