...
@OnlyIn(Dist.CLIENT)
public class EarthGolemShinobiRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EarthGolemShinobiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelearth_golem(), 0.3f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_shippuden:textures/entities/earth_golem.png");
					}
				};
			});
		}
