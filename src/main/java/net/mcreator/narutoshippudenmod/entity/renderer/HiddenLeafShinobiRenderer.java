...
@OnlyIn(Dist.CLIENT)
public class HiddenLeafShinobiRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HiddenLeafShinobiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlayer_Model(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_shippuden:textures/entities/hidden_leaf_shinobi.png");
					}
				};
			});
		}
