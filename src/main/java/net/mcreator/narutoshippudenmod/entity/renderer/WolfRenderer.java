...
import net.mcreator.narutoshippudenmod.entity.WolfEntity;
...
public class WolfRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WolfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwolf(), 0.3f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_shippuden:textures/entities/wolf.png");
					}
				};
			});
		}
