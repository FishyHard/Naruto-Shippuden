...
@OnlyIn(Dist.CLIENT)
public class AkamaruRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AkamaruEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelAkamaru_Young(), 0.15f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_shippuden:textures/entities/akamaru_young.png");
					}
				};
			});
		}
