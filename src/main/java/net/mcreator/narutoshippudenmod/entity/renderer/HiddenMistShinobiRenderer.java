...
@OnlyIn(Dist.CLIENT)
public class HiddenMistShinobiRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HiddenMistShinobiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlayer_Model(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_shippuden:textures/entities/hidden_mist_shinobi.png");
					}
				};
			});
		}
