...
import net.mcreator.narutoshippudenmod.procedures.ShikamaruRightClickedOnEntityProcedure;
import net.mcreator.narutoshippudenmod.itemgroup.SpawnEggsItemGroup;
import net.mcreator.narutoshippudenmod.entity.renderer.ShikamaruRenderer;
...
public class ShikamaruEntity extends NarutoShippudenModElements.ModElement {
