...
import net.mcreator.narutoshippudenmod.procedures.HiddenLeafShinobiOnEntityTickUpdateProcedure;
import net.mcreator.narutoshippudenmod.itemgroup.SpawnEggsItemGroup;
import net.mcreator.narutoshippudenmod.entity.renderer.HiddenLeafShinobiRenderer;
...
public class HiddenLeafShinobiEntity extends NarutoShippudenModElements.ModElement {
