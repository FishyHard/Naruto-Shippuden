...
import net.mcreator.narutoshippudenmod.procedures.HiddenMistShinobiOnEntityTickUpdateProcedure;
import net.mcreator.narutoshippudenmod.itemgroup.SpawnEggsItemGroup;
import net.mcreator.narutoshippudenmod.entity.renderer.HiddenMistShinobiRenderer;
...
public class HiddenMistShinobiEntity extends NarutoShippudenModElements.ModElement {
